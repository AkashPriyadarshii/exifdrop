...
Standing knowledge for ExifDrop (jr's local memory, not the repo wiki).

- [ARCHITECTURE.md](ARCHITECTURE.md) — standing decisions, format truth, edge cases.
- RELEASES.md — placeholder: v0.1 on GitHub Releases, F-Droid pending.
- PEOPLE.md — placeholder: principal Akash Priyadarshi (AkashPriyadarshii).
